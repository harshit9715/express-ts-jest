...
var server_1 = require("@exmpl/utils/server");
var server;
...
describe('GET /soccer/{teamId}/players', function () {
    it('should return 200 & valid response', function (done) {
    ...
    it('should return 404 & valid error response team id is invalid', function (done) {
        supertest_1.default(server)
